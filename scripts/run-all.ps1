...
Write-Host "  .\scripts\prove-sync.ps1                # run proof DML + cross-check source vs target"
Write-Host "  .\scripts\verify-replication.ps1        # re-check row counts"
Write-Host "  http://localhost:5000                   # CDC Audit Dashboard"
